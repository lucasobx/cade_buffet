...
Client.create!(name: 'Julia', personal_code: '47406693079', email: 'julia@email.com', password: '12345678')
...
f_buffet = Buffet.create!(brand_name: 'Casamentos Buffet', corporate_name: 'Casamentos Buffet LTDA',
                          ...
                          owner: f_owner, payment_methods: [cash, pix])
...
EventType.create!(name: 'Festa de Casamento', description: 'Espaço luxuoso e confortável',
                  ...
                  location_option: false, buffet: f_buffet, base_price: 10000.0, extra_guest: 250.0,
                  extra_hour: 1000.0, we_base_price: 15000.0, we_extra_guest: 400.0, we_extra_hour: 1500.0)

s_buffet = Buffet.create!(brand_name: 'Edecy Buffet', corporate_name: 'Edecy Buffet LTDA',
                          ...
                          owner: s_owner, payment_methods: [credit, debit])
...
EventType.create!(name: 'Piscina de Bolinhas', description: 'Festa infantil com fantasias',
                  ...
                  location_option: true, buffet: s_buffet, base_price: 5000.0, extra_guest: 100.0,
                  extra_hour: 500.0, we_base_price: 8000.0, we_extra_guest: 200.0, we_extra_hour: 800.0)

t_buffet = Buffet.create!(brand_name: 'La Luna Casamentos', corporate_name: 'La Luna Casamentos LTDA',
                          ...
                          owner: t_owner, payment_methods: [credit, debit])
...
EventType.create!(name: 'Festa de Casamento', description: 'Local espaçoso, versátil e confortável',
                  ...
                  alcohol_option: true, decoration_option: true, parking_service_option: true,
                  location_option: true, buffet: t_buffet, base_price: 5000.0, extra_guest: 100.0,
                  extra_hour: 500.0, we_base_price: 8000.0, we_extra_guest: 200.0, we_extra_hour: 800.0)