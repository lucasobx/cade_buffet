...
describe 'Cliente vê seus próprios pedidos' do
  it 'e não vê outros pedidos' do
    ...
    f_order = Order.create!(client: joao, buffet: buffet, event_type: event_type, event_date: 1.day.from_now,
                        estimated_guests: 30, event_details: 'Festa de aniversário', event_address: 'Rua da Praça, 273')
    s_order = Order.create!(client: maria, buffet: buffet, event_type: event_type, event_date: 1.day.from_now,
                        estimated_guests: 30, event_details: 'Festa de aniversário', event_address: 'Rua da Praça, 273')
    t_order = Order.create!(client: joao, buffet: buffet, event_type: event_type, event_date: 1.week.from_now,
                        estimated_guests: 30, event_details: 'Festa de aniversário', event_address: 'Rua da Praça, 273')
  ...
  it 'e visita um pedido' do
    ...
    event_type = EventType.create!(name: 'Festa dos Heróis', description: 'Festa infantil com temática de heróis',
                                   ...
                                   location_option: true, buffet: buffet, base_price: 5000.0, extra_guest: 100.0,
                                   extra_hour: 500.0, we_base_price: 8000.0, we_extra_guest: 200.0, we_extra_hour: 800.0)
    order = Order.create!(client: joao, buffet: buffet, event_type: event_type, event_date: 1.day.from_now,
                          estimated_guests: 30, event_details: 'Festa de aniversário', event_address: 'Rua da Praça, 273')
